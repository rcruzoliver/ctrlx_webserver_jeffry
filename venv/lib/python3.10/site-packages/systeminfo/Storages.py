...
class Storages(object):
    ...
    def Storages(self, j):
        ...
        if o != 0:
            ...
            from systeminfo.Storage import Storage
            obj = Storage()
...
class StoragesT(object):
    ...
    # StoragesT
    def __init__(self):
        self.storages = None  # type: List[systeminfo.Storage.StorageT]
        ...
        if not storages.StoragesIsNone():
            ...
            for i in range(storages.StoragesLength()):
                if storages.Storages(i) is None:
                    ...
                    storage_ = systeminfo.Storage.StorageT.InitFromObj(storages.Storages(i))
